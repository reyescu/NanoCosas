...
par1=squeeze(dat(:,:,1));%sweepstart
par2=squeeze(dat(:,:,2));%sweepend
...
ax{1}.array=squeeze(par3(:,1)');
ax{1}.s1=repmat(ax{1}.array',1,n2,n3);

ax{2}.array=squeeze(par4(1,:));
ax{2}.s1=repmat(ax{2}.array,n1,1,n3);

step=(par2(1,1)-par1(1,1))/(n3-1);
ax{3}.array=par1(1,1):step:par2(1,1);
